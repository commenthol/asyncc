...
describe('#connect', function () {
  ...
  it('with errors but no trap', function (done) {
    connect([
      ...
      assert.deepStrictEqual(res, { value: 11 })
      done()
    })
  })
  ...
  it('with 2 errors and two traps', function (done) {
    connect(
      ...
      assert.strictEqual(err, null)
      assert.deepStrictEqual(res, { value: 25, trap: ['error1', 'error2'] })
      done()
    })
  })
  ...
  it('with 2 thrown errors and two traps', function (done) {
    connect(
      ...
      assert.strictEqual(err, null)
      assert.deepStrictEqual(res, { value: 5, trap: [new Error('error1'), new Error('error2')] })
      done()
    })
  })
})
